 ...
 * 
 */
@WebServiceClient(name = "AutoresServiceService", targetNamespace = "http://servico.estoque.knight.com.br/", wsdlLocation = "http://localhost:8080/AutoresService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/AutoresService?wsdl");
    ...
    public AutoresService getAutoresServicePort() {
        return super.getPort(new QName("http://servico.estoque.knight.com.br/", "AutoresServicePort"), AutoresService.class);
    }
    ...
    public AutoresService getAutoresServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servico.estoque.knight.com.br/", "AutoresServicePort"), AutoresService.class, features);
    }

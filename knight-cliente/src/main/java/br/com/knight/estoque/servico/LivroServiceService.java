 ...
 * 
 */
@WebServiceClient(name = "LivroServiceService", targetNamespace = "http://servico.estoque.knight.com.br/", wsdlLocation = "http://localhost:8080/LivroService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/LivroService?wsdl");
     ...
     * 
     * @return
     *     returns LivroService
     */
    @WebEndpoint(name = "LivroServicePort")
    public LivroService getLivroServicePort() {
        return super.getPort(new QName("http://servico.estoque.knight.com.br/", "LivroServicePort"), LivroService.class);
    }
     ...
     */
    @WebEndpoint(name = "LivroServicePort")
    public LivroService getLivroServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servico.estoque.knight.com.br/", "LivroServicePort"), LivroService.class, features);
    }
